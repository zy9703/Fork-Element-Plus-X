...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ style: { "display": "flex", "flex-direction": "column", "gap": "12px" } }, _attrs))} data-v-9d8724a6><div style="${ssrRenderStyle({ "display": "flex" })}" data-v-9d8724a6>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/sender/demos/focus.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const focus = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-9d8724a6"]]);
export {
  focus as default
};
