...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ style: { "display": "flex", "flex-direction": "column", "gap": "20px" } }, _attrs))} data-v-fe1df01c>`);
      ...
      _push(ssrRenderComponent(_component_MentionSender, {
        ...
        prefix: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div style="${ssrRenderStyle({ "display": "flex", "align-items": "center", "gap": "8px", "flex-wrap": "wrap" })}" data-v-fe1df01c${_scopeId}>`);
            ...
            _push2(`<div class="${ssrRenderClass({ isSelect: unref(isSelect) })}" style="${ssrRenderStyle({ "display": "flex", "align-items": "center", "gap": "4px", "padding": "2px 12px", "border": "1px solid black", "border-radius": "15px", "cursor": "pointer", "font-size": "12px", "color": "black" })}" data-v-fe1df01c${_scopeId}>`);
            ...
            _push2(`<span data-v-fe1df01c${_scopeId}>深度思考</span></div></div>`);
          } else {
            return [
        ...
        "action-list": withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div style="${ssrRenderStyle({ "display": "flex", "align-items": "center", "gap": "8px" })}" data-v-fe1df01c${_scopeId}>`);
            _push2(ssrRenderComponent(_component_el_button, {
              round: "",
              color: "#626aef"
            }, {
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/mentionSender/demos/input-style.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const inputStyle = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-fe1df01c"]]);
export {
