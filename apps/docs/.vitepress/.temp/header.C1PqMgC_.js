...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ style: { "display": "flex", "flex-direction": "column", "gap": "12px", "height": "300px", "justify-content": "space-between" } }, _attrs))} data-v-11b24991>`);
      ...
      _push(ssrRenderComponent(_component_MentionSender, {
        ...
        header: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="header-self-wrap" data-v-11b24991${_scopeId}><div class="header-self-title" data-v-11b24991${_scopeId}><div class="header-left" data-v-11b24991${_scopeId}> 💯 欢迎使用 Element Plus X </div><div class="header-right" data-v-11b24991${_scopeId}>`);
            _push2(ssrRenderComponent(_component_el_button, { onClick: closeHeader }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(`<span data-v-11b24991${_scopeId2}>关闭头部</span>`);
                } else {
                  return [
            ...
            _push2(`</div></div><div class="header-self-content" data-v-11b24991${_scopeId}> 🦜 自定义头部内容 </div></div>`);
          } else {
            return [
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/mentionSender/demos/header.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const header = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-11b24991"]]);
export {
  header as default
};
