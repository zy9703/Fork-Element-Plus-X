...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ style: { "display": "flex", "flex-direction": "column", "gap": "12px" } }, _attrs))} data-v-3c5cc6b2>`);
      _push(ssrRenderComponent(_component_Sender, null, {
        "action-list": withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="action-list-self-wrap" data-v-3c5cc6b2${_scopeId}>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/sender/demos/action-list.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const actionList = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-3c5cc6b2"]]);
export {
