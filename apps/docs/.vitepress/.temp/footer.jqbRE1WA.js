...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ style: { "display": "flex", "flex-direction": "column", "gap": "20px" } }, _attrs))} data-v-5d6de0a4>`);
      _push(ssrRenderComponent(_component_MentionSender, {
        ...
        prefix: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div style="${ssrRenderStyle({ "display": "flex", "align-items": "center", "gap": "8px", "flex-wrap": "wrap" })}" data-v-5d6de0a4${_scopeId}>`);
        ...
        "action-list": withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div style="${ssrRenderStyle({ "display": "flex", "align-items": "center", "gap": "8px" })}" data-v-5d6de0a4${_scopeId}>`);
            _push2(ssrRenderComponent(_component_el_button, {
              round: "",
              color: "#626aef"
            }, {
        ...
        footer: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div style="${ssrRenderStyle({ "display": "flex", "align-items": "center", "justify-content": "center", "padding": "12px" })}" data-v-5d6de0a4${_scopeId}> 默认变体 自定义底部 </div>`);
          } else {
            return [
      ...
      _push(ssrRenderComponent(_component_MentionSender, {
        ...
        prefix: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<div class="${ssrRenderClass({ isSelect: unref(isSelect) })}" style="${ssrRenderStyle({ "display": "flex", "align-items": "center", "gap": "4px", "padding": "2px 12px", "border": "1px solid silver", "border-radius": "15px", "cursor": "pointer", "font-size": "12px" })}" data-v-5d6de0a4${_scopeId}>`);
            ...
            _push2(`<span data-v-5d6de0a4${_scopeId}>深度思考</span></div></div>`);
          } else {
            return [
              createVNode("div", { style: { "display": "flex", "align-items": "center", "gap": "8px", "flex-wrap": "wrap" } }, [
                createVNode(_component_el_button, {
        ...
        footer: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div style="${ssrRenderStyle({ "display": "flex", "align-items": "center", "justify-content": "center", "padding": "12px" })}" data-v-5d6de0a4${_scopeId}> updown 变体 自定义底部 </div>`);
          } else {
            return [
      ...
      _push(ssrRenderComponent(_component_MentionSender, {
        ...
        footer: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div style="${ssrRenderStyle({ "display": "flex", "align-items": "center", "justify-content": "center", "padding": "12px", "text-align": "center" })}" data-v-5d6de0a4${_scopeId}> showUpdown 属性 隐藏 updown 变体内置布局样式 + #footer 底部插槽结合，完全让你来控制底部内容 </div>`);
          } else {
            return [
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/mentionSender/demos/footer.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const footer = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-5d6de0a4"]]);
export {
  footer as default
};
