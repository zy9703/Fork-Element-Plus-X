import { h as __name, an as setAccDescription, ao as getAccDescription, aG as getDiagramTitle, aF as setDiagramTitle, ap as getAccTitle, aq as setAccTitle, p as log, ba as selectSvgElement, as as configureSvgSize, aL as clear$2, aT as getConfig, aS as cleanAndMerge, aU as defaultConfig_default, bt as getThemeVariables3, av as sanitizeText, bu as computeDimensionOfText, bv as line$1 } from "./useSend.GCLvJHLh.js";
import { i as initRange } from "./init-ZxktEp_H.ZxktEp_H.js";
import { o as ordinal } from "./ordinal-DSZU4PqD.2-AwyELI.js";
import { l as linear } from "./linear-DboPp3QM.DCReR3Sx.js";
import "vue";
...
var LinePlot = (_f = class {
  ...
  getDrawableElement() {
    ...
    if (this.orientation === "horizontal") {
      path = line$1().y((d) => d[0]).x((d) => d[1])(finalData);
    } else {
      path = line$1().x((d) => d[0]).y((d) => d[1])(finalData);
    }
    if (!path) {
      return [];
    }
